...
public class GenieMRTask extends RunnableTask {
    ...
    public GenieMRTask(final GenieMRTaskParameters taskParameters) {
        this.taskParameters = taskParameters;

    }

    public static Props create(final GenieMRTaskParameters taskParameters){
        ...
        if (msg instanceof TaskCommand){
            ...
            switch((TaskCommand)(msg)){
                ...
                case STATUS:
                    ...
                    TaskState curStat = checkStatus();
                    if (curStat==TaskState.FAILED){
                        logger.info("MR task " + genieJobId + " Failed to complete");

                    }else if(curStat ==TaskState.SUCCESS){
...
*/
        ...
        ActorRef cordRef = _system.actorOf(GenieMRTask.create(mrTaskParameters));
